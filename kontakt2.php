...
<body>
    <div class="home home2">
        ...
        <div class="kontakt2 row">
            <div class="lewa2 text-center col-md-6 p-5">
            ...
            <div class="prawa2 text-center col-md-6 p-5 ">
                ...
                <table class="zadzwon3">
                    <tr>
                        <td class="wlewo">Adres:</td>
                        <td class="wprawo">Wolna 34, 57-569 Piaseczno</td>
                    </tr>
                </table>
                <table class="zadzwon3">
                    <tr>
                        <td class="wlewo">E-mail:</td>
                        <td class="wprawo">kontakt@grotticars.com</td>
                    </tr>
                </table>
                <table class="zadzwon3">
                    <tr>
