...
<body>
    <div class="home">
        ...
        <div class="container mt-3 mb-3 p-auto row mx-auto text-center" style="background-color: #202020; color: white">
            <div class="mx-auto p-3 col-md-4">
                <h1>Nowy Grotti Spider</h1>
                <hr>
                <p>Już od 129 999zł, lub 1599zł miesięcznie</p>
                <a href="auto.php"><img class="img-fluid" src="image/lista-modeli.png"></a>
