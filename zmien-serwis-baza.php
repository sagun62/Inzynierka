...
<body>
    ...
    <div class="home">
        ...
        <div class="system container h-100 w-100 mx-auto">
            ...
            if ($result = $mysqli->query("UPDATE serwis SET ID='$id', Imie='$imie', Nazwisko='$nazwisko', Telefon='$telefon', Numer='$numer', Termin='$termin', Opis='$opis' WHERE ID='$id'")) {
                echo '
            ...
            <a href="admin.php"  class="edytuj">Wróc do Panelu</a><br><br>
                ...
                echo '
                <h1>nie dziala</h1>
                <form name="zmien-serwis-baza.php" action="zmien-serwis-baza.php" id="pdf" method="POST">
                <input type="text" value="<?= $id ?>" />
                <input type="text" value="<?= $imie ?>" />
                <input type="text" value="<?= $nazwisko ?>" />
                <input type="text" value="<?= $telefon ?>" />
                <input type="text" value="<?= $numer ?>" />
                <input type="text" value="<?= $termin ?>" />
                <input type="text" value="<?= $opis ?>" />
