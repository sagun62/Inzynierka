...
<body>
  <div class="home">
    ...
    <div class="chat-box container w-75 h-auto ">
      <div class="desc-text">
        <h1>Zadaj pytanie online</h1><br>
        <h3>Uzupełnij poniższe pola, by rozpocząć rozmowę</h3><br>
      </div>
      <form action="#">
        <div class="field">
          <input type="text" placeholder="Podaj Imię" required>
        </div>
        <div class="field">
          <input type="email" placeholder="Podaj E-mail" required>
        </div>
        <div class="field textarea">
          ...
          <textarea cols="30" rows="10" placeholder="Temat rozmowy" required></textarea>
        </div>
        <div class="field">
          <button type="submit">Rozpocznij rozmowe</button>
        </div>
      </form><br>
    </div>
